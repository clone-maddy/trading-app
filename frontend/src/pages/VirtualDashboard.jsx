  ...
  return (
    <div className="app">
      ...
      <div className="settings-card">
        ...
        >
          <h2 style={{ margin: 0 }}>⚙️ Global P&L Monitor Settings (Virtual)</h2>
          <span style={{ fontSize: '18px', fontWeight: 'bold' }}>{isSettingsOpen ? '▲' : '▼'}</span>
        </div>

        {isSettingsOpen && (
          <>
            <p className="subtitle" style={{ marginTop: '10px' }}>Automatically exit all virtual positions when total P&L hits these limits</p>
